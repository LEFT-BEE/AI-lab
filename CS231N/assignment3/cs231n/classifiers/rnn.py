...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == "rnn":
          dout , dh , grads["Wx"] , grads["Wh"] , grads["b"] = rnn_backward(dout , cache_score) 
        else:
          dout , dh , grads["Wx"] , grads["Wh"] , grads["b"] = lstm_backward(dout , cache_score) 
        grads["W_embed"] = word_embedding_backward(dout , cache_emb)
        dx , grads["W_proj"] , grads["b_proj"] = affine_backward(dout , cache_in)
